  ...
  return (
    <main className="max-w-md px-2 mx-auto">
      ...
      <form onSubmit={onSubmit}>
        ...
        <button
          type="submit"
          className="mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-800 hover:shadow-lg focus:bg-blue-800 active:bg-blue-800 transition duration-300 ease-in-out active:shadow-xl"
        >
          Create Listing
        </button>
      </form>
